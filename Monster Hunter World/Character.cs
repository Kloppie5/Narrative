...
namespace MonsterHunterWorld {
    class Character {
        ...
        public void Deserialize ( ) {
            ...
            UNKNOWN_DC_2B2 = new Byte[0x2B2];
            Array.Copy(data, 0xDC, UNKNOWN_DC_2B2, 0x0, 0x2B2);
            ...
            UNKNOWN_C03B1_0F3510 = new Byte[0x0F3510 - 0xC03B1];
            Array.Copy(data, 0xC03B1, UNKNOWN_C03B1_0F3510, 0x0, 0x0F3510 - 0xC03B1);
        ...
        public void Dump ( Boolean verbose = false, Boolean halting = false ) {
            ...
            Console.WriteLine($"  Name [{0x4:X} - {0x44:X}]");
            Console.WriteLine($"  HR [{0x44:X} - {0x48:X}]");
            Console.WriteLine($"  MR [{0x48:X} - {0x4C:X}]");
            Console.WriteLine($"  Zenny [{0x4C:X} - {0x50:X}]");
            Console.WriteLine($"  Research Points [{0x50:X} - {0x54:X}]");
            Console.WriteLine($"  HR XP [{0x54:X} - {0x58:X}]");
            Console.WriteLine($"  MR XP [{0x58:X} - {0x5C:X}]");
            Console.WriteLine($"  Playtime [{0x5C:X} - {0x60:X}]");
            ...
            Console.ForegroundColor = ConsoleColor.White;
            /*
            hex_dump(data, 0x0000DC, 0x0002B2, 32, (_) => {return ConsoleColor.Yellow;});
            // Palico appearance
            Console.ReadLine();
            */
            ...
            Console.ForegroundColor = ConsoleColor.White;
            /*
            hex_dump(data, 0x0C03B1, 0x0F3510, 32, (_) => {return ConsoleColor.Yellow;});
            ...
            */
            ...
            Console.ForegroundColor = ConsoleColor.White;
            /*
            hex_dump(data, 0x10A760, 0x116098, 32, (_) => {return ConsoleColor.Yellow;});
            // completely empty
            ...
            */
            ...
            /*
            hex_dump(data, 0x1A194C, 0x1A8D48, 32, (_) => {return ConsoleColor.Yellow;});
            // Weapon notice flags
            Console.ReadLine();
            */
            Console.ForegroundColor = ConsoleColor.White;
            ...
            Console.ForegroundColor = ConsoleColor.White;
            /*
            hex_dump(data, 0x1ACD48, 0x1AD5DF, 32, (_) => {return ConsoleColor.Yellow;});
            ...
            */
            ...
            Console.ForegroundColor = ConsoleColor.White;
            /**
            hex_dump(data, 0x1B60B1, 0x1B6955, 32, (_) => {return ConsoleColor.Yellow;});
            Console.ReadLine();
            */
            ...
            /**
            Console.WriteLine($"  Equipment Layout indices? [{0x1DB8D5:X} - {0x0:X}] | 224 Int16");
            ...
            */
            ...
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine($"  UNKNOWN [{0x1E5ED5:X} - {0x1E7082:X}]");
            Console.ForegroundColor = ConsoleColor.White;
            /*
            hex_dump(data, 0x1E5ED5, 0x1E7082, 32, (_) => {return ConsoleColor.Yellow;});
            ...
            */
            Console.ForegroundColor = ConsoleColor.Red;
            // Console.WriteLine($"  UNKNOWN [{0x1E7082:X} - {0x1EA202:X}] | 96*<0x84> << not \"anymore\"");
            Console.WriteLine($"  UNKNOWN [{0x1E7082:X} - {0x2098C0:X}]");
            Console.ForegroundColor = ConsoleColor.White;
            /*
            hex_dump(data, 0x1EA202, 0x2098C0, 32, (_) => {return ConsoleColor.Yellow;});
