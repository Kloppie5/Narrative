...
namespace CultistSimulator {
  public class ProcessManager : Narrative.ProcessManager64 {
    ...
    public void ExtractTabletopSphere ( ) {
      tokens.Clear();
      Int32 tokenList = MemoryHelper.ReadAbsolute<Int32>(this, tabletopSphere + 0x28);
      Int32 tokenArray = MemoryHelper.ReadAbsolute<Int32>(this, tokenList + 0x8);
    ...
    public void Open ( Int32 situation ) {
      Int32 situationVTable = MemoryHelper.ReadAbsolute<Int32>(this, situation);
      Int32 situationClass = MemoryHelper.ReadAbsolute<Int32>(this, situationVTable);
      Int32 Open = injector.ClassGetMethodByName(situationClass, "Open");
      injector.InvokeMethod<Int32>(Open, situation);
    }
    ...
    public String TokenToPrettyString ( Int32 token ) {
      ...
      if ( payloadClassName == "ElementStack" ) {
        ...
        Console.WriteLine($"Token: {labelString} at {token:X}");
      ...
      if ( payloadClassName == "Situation" ) {
        ...
        Int32 label = MemoryHelper.ReadAbsolute<Int32>(this, verb + 0x1C);
        String labelString = MemoryHelper.ReadAbsoluteMonoWideString(this, label);
        Int32 id = MemoryHelper.ReadAbsolute<Int32>(this, payload + 0x20);
        String idString = MemoryHelper.ReadAbsoluteMonoWideString(this, id);
        Console.WriteLine($"Situation: {labelString} at {payload:X8}");
